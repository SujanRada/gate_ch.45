...
\begin{align}
    ...
    \implies K\brak{s} &= \frac{4\brak{1-s}}{8s^2 + \brak{4-K_c}s + K_c}    \\
    \implies K\brak{s} &= \frac{\brak{1-s}}{2\brak{s-s_1}\brak{s-s_2}}  \label{eq:ch.3}
\end{align}
Where,
\begin{align}
...
\end{align}
From \eqref{eq:ch.3} we get,
\begin{align}
    K\brak{s} &= \frac{1}{2\brak{s_1-s_2}}\brak{\frac{1-s_1}{s-s_1}-\frac{1-s_2}{s-s_2}}
\end{align}
Now taking the inverse laplace transform we have,
\begin{align}
    k\brak{t} &= \frac{1}{2\brak{s_1-s_2}} \left [\brak{1-s_1}e^{s_1t}-\brak{1-s_2}e^{s_2t} \right ]  \\
    \implies k\brak{t} &= e^{\frac{K_c-4}{16}}\brak{A_1e^{\sqrt{\brak{\frac{K_c-4}{16}}^2 - \frac{K_c}{8}}} - A_2e^{-\sqrt{\brak{\frac{K_c-4}{16}}^2 - \frac{K_c}{8}}}}    
\end{align}
Where,
\begin{align}
